...
Last README file update: Thu Jul 27 14:49:54 JST 2023
...
command.sbc
command.sbc.home
command.sbc.list-archived
command.sbc.lobby
command.sbc.prune
command.sbc.prune-all
command.sbc.prune.dimension
command.sbc.reload-and-export-biomes
command.sbc.reload-and-export-biomes.max-distance
command.sbc.restore
command.sbc.restore.player
command.sbc.restore.player.dimension
command.sbc.visit
command.sbc.visit.team
command.schedule
